...
import { WabaRelayIngressModule } from './modules/waba-relay-ingress/waba-relay-ingress.module';
...
@Module({
  imports: [
    ...
    WabaRelayIngressModule, // Push assinado do hub WABA (engine waba-relay)
